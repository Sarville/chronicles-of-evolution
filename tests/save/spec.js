...
assert.equal(loaded.envelope.rulesetVersion, 'timeline1-v14-blight-timer');
...
assert.equal(migratedV2.rulesetVersion, 'timeline1-v14-blight-timer');
...
assert.equal(migratedV3.rulesetVersion, 'timeline1-v14-blight-timer');
...
assert.equal(migratedV4.rulesetVersion, 'timeline1-v14-blight-timer');
...
assert.equal(migratedV5.rulesetVersion, 'timeline1-v14-blight-timer');
...
assert.equal(migratedV6.rulesetVersion, 'timeline1-v14-blight-timer');
...
assert.equal(migratedV9.rulesetVersion, 'timeline1-v14-blight-timer');
