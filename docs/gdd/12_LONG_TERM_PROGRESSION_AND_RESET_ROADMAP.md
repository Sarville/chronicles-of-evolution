...
`Timeline #1` на 0–180 минут — не весь продукт и не сокращённая замена Evolve. Это первый доказанный вертикальный срез продукта, который по PRD должен привести к нескольким видам, космосу и первому Bioseed за первые 8–12 часов активной игры.
...
|---|---:|---:|---|---|
| `T1` — Origin | 0–3 ч | 177–183 мин | жизнь → цивилизация → Atomic; базовая event deck | первый обязательный `Ash` |
