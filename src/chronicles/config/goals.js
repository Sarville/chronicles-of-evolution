...
export const goals = [
  ...
  {
    id: 'G006',
    title: 'Откройте метаболизм',
    description: 'Завершите C01 Metabolism, чтобы открыть Energy как реальный клеточный процесс.',
    targetTimeMs: 660000,
    nodeId: 'C01',
    chapterId: 'CH02',
    slot: 'chapter',
    ...
    conditions: [{ type: 'node_completed', nodeId: 'C01' }],
    rewards: [],
    cta: { type: 'node', targetId: 'C01', label: 'Развить Metabolism' },
    highlight: { type: 'node', targetId: 'C01' },
    hintTimeoutMs: 90000,
    hint: 'Biomass уже накапливается после Cell; потратьте его на Metabolism, чтобы открыть Energy.',
  },
  {
    id: 'G007',
    title: 'Выберите путь клетки',
    description:
      'Выберите один primary trait — Absorption, Symbiosis или Shell — и завершите C03 Protein Synthesis / Ribosome.',
    targetTimeMs: 780000,
    nodeId: 'C03',
    chapterId: 'CH02',
    slot: 'chapter',
    sequence: { previousGoalId: 'G006', nextGoalId: 'G008' },
    prerequisites: [{ type: 'node_completed', nodeId: 'C01' }],
    conditions: [{ type: 'node_completed', nodeId: 'C03' }],
    rewards: [],
    cta: { type: 'node', targetId: 'C03', label: 'Развить Protein Synthesis' },
    highlight: { type: 'node', targetId: 'C02A' },
    hintTimeoutMs: 120000,
    hint: 'Выбор необратим для Timeline #1: Absorption ускоряет Biomass, Symbiosis даёт стабильный рост, Shell снижает потери.',
  },
  {
    id: 'G008',
    title: 'Развейте органеллы',
    description: 'Завершите C05 Organelles, чтобы специализировать внутренние процессы клетки.',
    targetTimeMs: 900000,
    nodeId: 'C05',
    chapterId: 'CH02',
    slot: 'chapter',
    sequence: { previousGoalId: 'G007', nextGoalId: 'G009' },
    prerequisites: [{ type: 'node_completed', nodeId: 'C03' }],
    conditions: [{ type: 'node_completed', nodeId: 'C05' }],
    rewards: [],
    cta: { type: 'node', targetId: 'C05', label: 'Развить Organelles' },
    highlight: { type: 'node', targetId: 'C05' },
    hintTimeoutMs: 120000,
    hint: 'Organelles усиливают всю клеточную экономику разом.',
  },
  {
    id: 'G009',
    title: 'Скоординируйте клетку',
    description: 'Завершите C06 Cell Coordination — последний шаг перед Multicellularity.',
    targetTimeMs: 1080000,
    nodeId: 'C06',
    chapterId: 'CH02',
    slot: 'chapter',
    sequence: { previousGoalId: 'G008' },
    prerequisites: [{ type: 'node_completed', nodeId: 'C05' }],
    conditions: [{ type: 'node_completed', nodeId: 'C06' }],
    rewards: [
      { type: 'grant_resource', resourceId: 'ap', amount: 1 },
      { type: 'set_flag', flag: 'milestone.cell_coordination_reached', value: true },
    ],
    cta: { type: 'node', targetId: 'C06', label: 'Развить Cell Coordination' },
    highlight: { type: 'node', targetId: 'C06' },
    hintTimeoutMs: 150000,
    hint: 'Cell Coordination готовит клетку к переходу в многоклеточность.',
  },
  {
